...
let update_rate counters (k,a) =
  ...
  let rec update_bool k = match k with
    ...
    | Alg_expr.BOOL_OP (op,(k1,a1),(k2,a2)) ->
       Alg_expr.BOOL_OP (op,((update_bool k1),a1),((update_bool k2),a2))
    | Alg_expr.COMPARE_OP (op,(k1,a1),(k2,a2)) ->
       Alg_expr.COMPARE_OP (op,((update_expr k1),a1),((update_expr k2),a2)) and
  update_expr k = match k with
